        ...
        Column {
            ...
            Column(
                ...
                CameraButton(onPictureTook = {
                    viewModel.onEvent(EmotionRecognitionEvent.OnUriReady(it))
...
private suspend fun Context.createImageFile(): Uri {
    return withContext(Dispatchers.IO) {
        val imagePath = File(filesDir, "")
        val newFile = File(imagePath, "image.png")
        getUriForFile(this@createImageFile, "$packageName.fileprovider", newFile)
    }
}
